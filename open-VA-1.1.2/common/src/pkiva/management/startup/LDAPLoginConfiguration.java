...
public class LDAPLoginConfiguration extends GenericPropertiesStartup
{
  ...
  public static final String BIND_DN = "pkiva.ldap.login.binddn";
  
  public LDAPLoginConfiguration ()
  {
    PROPERTIES_FILE = "LDAPLoginConfiguration.properties";
    INFO = "LDAP login configuration";
  }
 
  public static void main(String[] args)
  {
    LDAPLoginConfiguration startup = new LDAPLoginConfiguration ();
    startup.load();
  }
}
