...
/**
 * Wraps an DERUnknownTag
 * @author  caller
 */
public class DERUnknownTagWrapper extends DERObjectWrapper {
    
    /** Creates a new instance of DERUnknownTagWrapper 
     * @param o Object to wrap
     */
    public DERUnknownTagWrapper(DERObject o) {
        super(o);
    }

    /**
     * Returns the tag represented by this object
     * @return the tag represented by this object
     */
    public int getTag(){
        return ((DERUnknownTag)obj).getTag();
    }
     ...
     */
    public byte[] getData(){
        return ((DERUnknownTag)obj).getData();
    }
