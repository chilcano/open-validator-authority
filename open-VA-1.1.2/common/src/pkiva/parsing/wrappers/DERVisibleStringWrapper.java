...
/**
 * Wraps an DERVisibleString
 * @author  caller
 */
public class DERVisibleStringWrapper extends DERObjectWrapper {

    /** Creates a new instance of DERVisibleStringWrapper
     * @param o Object to wrap
     */
    public DERVisibleStringWrapper(DERObject o) {
        super(o);
    }
    ...
    public String getString(){
        return ((DERVisibleString)obj).getString();
    }
    ...
    public byte[] getOctets() {
        return ((DERVisibleString)obj).getOctets();
    }
