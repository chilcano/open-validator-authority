 ...
 * @author  caller
 */
public class DERUTCTimeWrapper extends DERObjectWrapper {
    
    /** Creates a new instance of DERUTCTimeWrapper 
     * @param o Object to wrap
     */
    public DERUTCTimeWrapper(DERObject o) {
        super(o);
    }
