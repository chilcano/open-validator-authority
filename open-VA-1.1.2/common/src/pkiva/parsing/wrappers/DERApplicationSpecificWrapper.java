...
/**
 * Wraps a DERApplicationSpecific
 * @author  caller
 */
public class DERApplicationSpecificWrapper extends DERObjectWrapper {
    
    /** Creates a new instance of DERApplicationSpecificWrapper
     * @param o Object to wrap
     */
    public DERApplicationSpecificWrapper(DERObject o) {
        super(o);
    }
    
    public byte[] getContents(){
        return ((DERApplicationSpecific)obj).getContents();
    }
    
    public boolean isConstructed(){
        return ((DERApplicationSpecific)obj).isConstructed();
    }
    ...
    public String toString(){
        return toHexaReadable(getContents());
    }
}
