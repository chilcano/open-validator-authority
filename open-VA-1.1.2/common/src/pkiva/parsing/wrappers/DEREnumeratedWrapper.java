...
/**
 * Wraps a DEREnumerated
 * @author  caller
 */
public class DEREnumeratedWrapper extends DERObjectWrapper {
    
    /** Creates a new instance of DEREnumeratedWrapper 
     * @param o Object to wrap
     */
    public DEREnumeratedWrapper(DERObject o){
        super(o);
    }
    ...
    public java.math.BigInteger getValue(){
        return ((DEREnumerated)obj).getValue();
    }
