...
/**
 * Wraps an DERUniversalString
 * @author  caller
 */
public class DERUniversalStringWrapper extends DERObjectWrapper {
    
    /** Creates a new instance of DERUniversalStringWrapper 
     * @param o Object to wrap
     */
    public DERUniversalStringWrapper(DERObject o) {
        super(o);
    }
    ...
    public String getString(){
        return ((DERUniversalString)obj).getString();
    }
    ...
    public byte[] getOctets() {
        return ((DERUniversalString)obj).getOctets();
    }
