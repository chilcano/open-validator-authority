...
/**
 * Wraps an DERPrintableString
 * @author  caller
 */
public class DERPrintableStringWrapper extends DERObjectWrapper {
    
    /** Creates a new instance of DERPrintableStringWrapper 
     * @param o Object to wrap
     */
    public DERPrintableStringWrapper(DERObject o) {
        super(o);
    }
    ...
    public byte[] getOctets() {
        return ((DERPrintableString)obj).getOctets();
    }
