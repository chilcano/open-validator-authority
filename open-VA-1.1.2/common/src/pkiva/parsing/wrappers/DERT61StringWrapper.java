...
/**
 * Wraps an DERT61String
 * @author  caller
 */
public class DERT61StringWrapper extends DERObjectWrapper {
    
    /** Creates a new instance of DERT61StringWrapper 
     * @param o Object to wrap
     */
    public DERT61StringWrapper(DERObject o) {
        super(o);
    }
    ...
    public String getString(){
        return ((DERT61String)obj).getString();
    }
