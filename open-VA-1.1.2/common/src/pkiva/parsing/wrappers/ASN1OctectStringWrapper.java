...
/**
 * Wraps an ASN1OctectString
 * @author  caller
 */
public class ASN1OctectStringWrapper extends DERObjectWrapper {
    
    /** Creates a new instance of DERASN1OctectString 
     * @param o Object to wrap
     */
    public ASN1OctectStringWrapper(DERObject o) {
        super(o);
    }
    ...
    public String toString(){
        return "OCTECTSTRING: "+getOctets().length+" bytes.";
    }
