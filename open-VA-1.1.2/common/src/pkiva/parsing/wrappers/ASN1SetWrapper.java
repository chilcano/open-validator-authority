 ...
 * @author  caller
 */
public class ASN1SetWrapper extends DERObjectWrapper{
    protected Vector vObjects = null;

    /** Creates a new instance of ASN1SetWrapper
     * @param s Object to wrap
     */
    public ASN1SetWrapper(DERObject s){
        super(s);
        DERSet sset = (DERSet) s;
        vObjects = new Vector(sset.size());
        for(Enumeration e=sset.getObjects();e.hasMoreElements();){
