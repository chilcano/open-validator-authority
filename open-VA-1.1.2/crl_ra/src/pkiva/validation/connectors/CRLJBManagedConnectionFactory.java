 ...
 */
public class CRLJBManagedConnectionFactory 
...
//    static Category log = Category.getInstance(LDAPJBManagedConnectionFactory.class);
    ...
    public CRLJBManagedConnectionFactory()
    {
    }
...
//        pkiva.log.LogManager.getLogger(this.getClass()).debug("#### %%%% createConnectionFactory, cm=" + cm);
        CRLJBRequestInfo fsInfo = new CRLJBRequestInfo();
        return new CRLJBDirContextFactoryImpl(cm, this, fsInfo);
    }
...
//        pkiva.log.LogManager.getLogger(this.getClass()).debug("#### %%%% createManagedConnection, subject=" + subject + ", info=" + info);
        CRLJBRequestInfo fsInfo = (CRLJBRequestInfo) info;
        return new CRLJBManagedConnection(subject, fsInfo);
    }
