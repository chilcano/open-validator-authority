...
public class CertValidationChannelResourceAdapterMetaDataImpl
implements ResourceAdapterMetaData
{
  ...
  private static final String ADAPTER_NAME = "CertValidationChannel Resource Adapter";
  ...
  { "pkiva.validate..CertValidationChannelInteractionSpecImpl" };
  
  public CertValidationChannelResourceAdapterMetaDataImpl()
  {
    super();
  }
