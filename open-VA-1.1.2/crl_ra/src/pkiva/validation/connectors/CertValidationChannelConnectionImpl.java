...
abstract public class CertValidationChannelConnectionImpl implements Connection
{
  ...
  public CertValidationChannelConnectionImpl(ManagedConnection mc)
  {
    super();
    this.mc = mc;
    valid = true;
  ...
  abstract public Interaction createInteraction() throws ResourceException ;
    /*public Interaction createInteraction() throws ResourceException {
        if (valid)
            return new CertValidationChannelInteractionImpl(this);
         else
  ...
  {
    if (valid)
      return new CertValidationChannelConnectionMetaDataImpl();
    else
      throw new ResourceException(CLOSED_ERROR);
  }
  ...
  {
    if (valid) ((CertValidationChannelManagedConnectionImpl) mc).close();
  }
