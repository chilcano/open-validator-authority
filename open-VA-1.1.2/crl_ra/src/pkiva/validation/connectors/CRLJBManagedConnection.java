 ...
 */
public class CRLJBManagedConnection implements ManagedConnection
{
   ArrayList listeners = new ArrayList();
   CRLJBDirContextImpl conn;

   /** Creates new FSManagedConnection */
   public CRLJBManagedConnection(Subject subject,
      CRLJBRequestInfo fsInfo)
   {
...
//      pkiva.log.LogManager.getLogger(this.getClass()).debug("#### %%%% getConnection, subject="+subject+", info="+info);
      if( conn == null )
         conn = new CRLJBDirContextImpl(this);
      return conn;
   }
...
//      pkiva.log.LogManager.getLogger(this.getClass()).debug("#### %%%% getMetaData");
      return new CRLJBManagedConnectionMetaData();
   }
