...
public interface SignatureLocal   extends EJBLocalObject
{
   ...
   * @throws java.rmi.RemoteException ejb
   * @throws pkiva.exceptions.SignerException If signature fails for any reason.
   ...
   * @throws pkiva.exceptions.DigitalSignatureValidationErrorException In case of error.
  ...
  * @return true if signature validation succeedes, false otherwise.
  */
  public boolean verifyDigest(byte[] pkcs7, byte[] texto) throws   DigitalSignatureValidationErrorException;
}
