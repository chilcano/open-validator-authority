...
public interface CertificateLocal   extends EJBLocalObject
{
     ...
     * @throws java.security.cert.CertificateException If certificate error occurs.
     * @return The object retrieved from certificate, or null if nothing appropiate is found.
     */
    public Object getData(byte[] cert, String dataItem) throws CertificateException;
     ...
     */
    public Object getData(X509Certificate cert, String dataItem) throws CertificateException;
