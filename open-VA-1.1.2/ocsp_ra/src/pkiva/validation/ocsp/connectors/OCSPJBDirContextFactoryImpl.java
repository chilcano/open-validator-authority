 ...
 */
public class OCSPJBDirContextFactoryImpl implements OCSPJBDirContextFactory
{
   private transient ConnectionManager manager;
   private transient ManagedConnectionFactory factory;
   private transient OCSPJBRequestInfo fsInfo;
   private Reference reference;

   OCSPJBDirContextFactoryImpl(ConnectionManager manager,
      ManagedConnectionFactory factory, OCSPJBRequestInfo fsInfo)
   {
...
//      pkiva.log.LogManager.getLogger(this.getClass()).debug("#### %%%% ctor, fsInfo="+fsInfo);
   ...
   public OCSPJBDirContext getConnection() throws NamingException
   {
      //log.debug("getConnection", new Exception("CalledBy:"));
//      pkiva.log.LogManager.getLogger(this.getClass()).debug("#### %%%% getConnection");
      OCSPJBDirContext dc = null;
      try
      {
         dc = (OCSPJBDirContext) manager.allocateConnection(factory, fsInfo);
      }
