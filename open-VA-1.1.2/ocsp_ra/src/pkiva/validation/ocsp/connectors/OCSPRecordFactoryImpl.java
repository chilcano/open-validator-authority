...
public class OCSPRecordFactoryImpl implements RecordFactory
{
  ...
  {
    OCSPIndexedRecordImpl record = null;
    if ((recordName.equals(OCSPIndexedRecordImpl.INPUT))
    || (recordName.equals(OCSPIndexedRecordImpl.OUTPUT)))
    {
      record = new OCSPIndexedRecordImpl();
