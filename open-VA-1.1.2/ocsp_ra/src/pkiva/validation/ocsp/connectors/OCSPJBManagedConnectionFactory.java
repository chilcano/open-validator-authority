 ...
 */
public class OCSPJBManagedConnectionFactory 
...
//    static Category log = Category.getInstance(LDAPJBManagedConnectionFactory.class);
    ...
    public OCSPJBManagedConnectionFactory()
    {
    }
...
//        pkiva.log.LogManager.getLogger(this.getClass()).debug("#### %%%% createConnectionFactory, cm=" + cm);
        OCSPJBRequestInfo fsInfo = new OCSPJBRequestInfo();
        return new OCSPJBDirContextFactoryImpl(cm, this, fsInfo);
    }
...
//        pkiva.log.LogManager.getLogger(this.getClass()).debug("#### %%%% createManagedConnection, subject=" + subject + ", info=" + info);
        OCSPJBRequestInfo fsInfo = (OCSPJBRequestInfo) info;
        return new OCSPJBManagedConnection(subject, fsInfo);
    }
