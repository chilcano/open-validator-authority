...
public class OCSPManagedConnectionImpl implements ManagedConnection
{
  
  private static final String TRANSACTIONS_NOT_SUPPORTED_ERROR =	"Transactions not supported";
  protected OCSPConnectionImpl connection;
  private Vector listeners = new Vector();
  private PrintWriter out;
  
  public OCSPManagedConnectionImpl()
  {
    super();
  }
...
//          at pkiva.ldap.connectors.LDAPConnectionFactoryImpl.getConnection(Unknown Source)
  ...
  {
    connection = new OCSPConnectionImpl(this);
    return connection;
  }
  ...
  {
    return new OCSPManagedConnectionMetaDataImpl(connection.getMetaData());
  }
